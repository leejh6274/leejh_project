...
<section class="mt-5">
	...
	<form class="table-box-type-1" method="POST" action="../article/doWrite" onsubmit="AtricleWrite__submit(this); return false;">
      ...
      <colgroup>
        ...
        <tbody>
          ...
          <tr>
            <th>작성</th>
            <td>
            	<input type="submit" class="btn btn-active btn-primary" value="작성"/>
